...
================================================================================================================= ]]
function item_ring_of_draco_on_spell_start(keys)
	swap_to_item(keys, "item_ring_of_draco_inactive")
end
...
================================================================================================================= ]]
function item_ring_of_draco_inactive_on_spell_start(keys)
	swap_to_item(keys, "item_ring_of_draco")
end
