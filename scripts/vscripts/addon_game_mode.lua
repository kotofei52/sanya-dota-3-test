...
--	CustomNetTables:SetTableValue( "test", "value 2", { a = 1, b = 2 } );
	...
	GameRules:GetGameModeEntity():SetFountainPercentageHealthRegen( 5 )
	...
	--function COverthrowGameMode:OrderFilter( order ) 
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_sniper" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_sniper" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_sniper" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_sniper" then return false
	--	end
		
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_slardar" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_slardar" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_slardar" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_slardar" then return false
	--	end
		
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_omniknight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_omniknight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_omniknight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_omniknight" then return false
	--	end
		
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_night_stalker" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_night_stalker" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_night_stalker" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_night_stalker" then return false
	--	end
		
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_chaos_knight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_chaos_knight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_chaos_knight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_chaos_knight" then return false
	--	end
		
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_broodmother" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_broodmother" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_broodmother" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_broodmother" then return false
	--	end
		
	--	if order.order_type == DOTA_UNIT_ORDER_DROP_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_dragon_knight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_GIVE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_dragon_knight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_SELL_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_dragon_knight" then return false
	--	end
	--	if order.order_type == DOTA_UNIT_ORDER_DISASSEMBLE_ITEM and EntIndexToHScript( order.entindex_ability ):GetAbilityName() == "item_ultimate_scepter" and EntIndexToHScript( order.units['0'] ):GetUnitName() == "npc_dota_hero_dragon_knight" then return false
	--	end
	--	return true
	--end
end
